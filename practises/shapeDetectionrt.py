...
while 1:
    ...
    ls = cv2.getTrackbarPos("Lower-Saturatiom","Settings")
    ...
    for cnt in contours: #merkezi bulmak için
        area = cv2.contourArea(cnt)
        epsilon = 0.02*cv2.arcLength(cnt,True) #true şeklin kapalı olduğunu ifade eder
